...
class Site(Base):
    ...
    def restore_site(
        ...
        database_file = database_file.replace(sites_directory, "/home/ivend/ivend-bench/sites")
        public_file = public_file.replace(sites_directory, "/home/ivend/ivend-bench/sites")
        private_file = private_file.replace(sites_directory, "/home/ivend/ivend-bench/sites")
